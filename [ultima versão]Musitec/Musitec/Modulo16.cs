...
namespace Musitec
{
    public partial class Modulo16 : Form
    {

        string idLogin;
        int Modulo = 16;
        public Modulo16(string idLogin)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            btnA14.Region = new Region(forma);
            btnA15.Region = new Region(forma);
        ...
        private void Modulo16_Load(object sender, EventArgs e)
        {
