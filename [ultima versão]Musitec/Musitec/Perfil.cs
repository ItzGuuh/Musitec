...
namespace Musitec
{
    public partial class Perfil : Form
    {
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Você deseja mesmo sair do Musitec?", "Sair", MessageBoxButtons.YesNo);
        ...
        {
            AlterarSenha alt = new AlterarSenha(idLogin);
            alt.Show();
            this.Hide();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            aux = "Alterar";
            Metodos met = new Metodos();
            met.BuscarLogin(idLogin);
            Login = met.Login;
            FotoUsuario fot = new FotoUsuario(Login,aux);
            fot.Show();
            this.Hide();
        }
        ...
        {
            AlterarEmail alt = new AlterarEmail(idLogin);
            alt.Show();
            this.Hide();
        }
    }
