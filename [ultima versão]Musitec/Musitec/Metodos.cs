...
namespace Musitec
{
...

    {
        ...
        public void AlterarSenha(string idLogin, string SenhaNova)
        {
            try
            {
                ...
                cx.conectar();
                string sql = "";
                sql = " Update Cadastro set Senha = @SenhaNova WHERE idCadastro = @idLogin";
                MySqlCommand cd = new MySqlCommand();
                cd.Parameters.AddWithValue("@SenhaNova", SenhaNova);
                ...
                MessageBox.Show("Sua senha foi alterada com sucesso!", "Sucesso!");

            }

            catch
            {
                MessageBox.Show("Não foi possível trocar a sua senha!", "Erro");
            }


        }

        public void AlterarEmail(string idLogin, string EmailNovo)
        {
            try
            {
                ...
                cx.conectar();
                string sql = "";
                sql = " Update Cadastro set Email = @EmailNovo WHERE idCadastro = @idLogin";
                MySqlCommand cd = new MySqlCommand();
                cd.Parameters.AddWithValue("@EmailNovo", EmailNovo);
                cd.Parameters.AddWithValue("@idLogin", idLogin);
                ...
                MessageBox.Show("Seu email foi alterado com sucesso!", "Sucesso!");

            }

            catch
            {
                MessageBox.Show("Não foi possível trocar o seu email!", "Erro");
            }
        ...
        public void BuscarLogin(string idLogin)
        {
            try
            {
                ...
                cx.conectar();
                string sql = "";
                sql = "select Login From cadastro where idCadastro = @idLogin";
                MySqlCommand cd = new MySqlCommand();
                cd.Parameters.AddWithValue("@idLogin", idLogin);
                cd.Connection = cx.cn;
                cd.CommandText = sql;
            ...
            {
                MessageBox.Show("Nâo foi possível buscar seu Login!", "Erro");
            }
