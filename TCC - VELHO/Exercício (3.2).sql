...
é um modelo de cifra usado nas diversas casas e sendo um acorde diferente em cada uma delas.
...
1) Toque qualquer nota do violão e escute bem sua tonalidade. Agora, toque uma nota igual a essa em outra corda e compare sua semelhança.  
 ...
 ');
insert into Exercicios(conteudo) values ('Procurando uma melodia      
       Escolha uma música qualquer que conheça bem e procure as notas de sua melodia. Vá tocando e anotando as notas pelo sistema de cifragem de melodia. Não se aprece, mas seja perseverante. Use a técnica do ouvido para saber quando a nota sobe ou baixa. 
Complete a cifragem
            Depois de fazer o exercício anterior, inicie a trabalhar este. A tarefa é a seguinte; complete as lacunas com as notas restantes da melodia de música abaixo. Usamos as casas 2, 3, 4e 5  para os respectivos dedos  1, 2, 3,  e  4. 


ASA BRANCA  Luiz Gonzaga
454	231	343	__	__	343	__	__
QUAN – DO O – LHEI	A TER – RA AR – DEN - DO
__	__	__	232__	__	343		
QUAL FO – GUEI – RA DE SÃO JOÃO		
__	__	__	343	__ 232	__		__	__ 354
EU PER – GUN – TE - EI Ó DEUS DO CÉU UAI
__	__	__	321	__	__	__	454__	
POR QUE TA – MA – NHA JU – DIA –A –ÇÃO
454	__	__	__	232	__	__	__	454	__
EU PER – GUN – TE - EI	Ó DEUS DO CÉU UAI
354	__	321	__	__	321	__	__	454	
POR QUE TA – MA – NHA JU – DIA –A –ÇÃO
  Faça a sua própria pesquisa e escreva melodias de músicas de sua preferência.. Uma boa dica é procurar por canções instrumentais. A habilidade em tocar melodia desenvolve o aprendizado com rapidez.  
');

insert into Exercicios(conteudo) values ('Vimos a melodia da canção “Caminhando e cantando’’. Agora vamos executar o seu acompanhamento usando os acordes apropriados. É uma música simples que usa apenas dois acordes. Quanto ao ritmo, não leve em conta por enquanto, toque como puder. O importante de imediato é exercitar a troca de acordes.           
  Para começar, vamos precisar dos acordes D e Em. Fica por sua conta procurá-los e desenhar suas cifras. Depois é só tocar o acorde que está sobre a letra da música até quando encontrar outro acorde. Vamos lá? 
 PARA NÃO DIZER QUE NÃO FALEI DAS FLORES (Caminhando e cantando) 
Em	D	Em
...
REFRÃOVem, vamos embora que esperar não é saber
...
');
insert into Exercicios(conteudo) values ('Veja as fórmulas para acordes maiores e menores com 7m. Sua tarefa é identificar os acordes de acordo com a colocação das casas a partir do primeiro que já está denominado. A maneira mais prática é observar a nota do baixo que é o próprio acorde. Vamos lá
...
5)	Em F#7 B7 Em
');
insert into Exercicios(conteudo) values ('1ª-Formula: Para acordes menores com 7m:	2a-FÓRMULA; Para acordes menores com 7m:');
insert into Exercicios(conteudo) values ('3ª-Formula: Para acordes menores com');
insert into Exercicios(conteudo) values ('Pratique as seguintes seqüências envolvendo acordes maiores e menores com 7m. Toque em ritmo qualquer e repita varias vezes, comparando a tonalidade de cada acorde.

1)	Am7Bm7	Am7	Bm7	Am7 D7 G
2)	F Gm7Am7 Bb C7	F
3)	D F#m7 B7	Em7	Gm	A7 D
4)	A C#m7 Cm7 Bm7 E7A
5)	Dm F G  A7  Dm
6)	C	Em7	Dm7	G7	C
7)	G	Bm7	Dm7	G7	CCm Bm7 E7  Am7 D7
');
insert into Exercicios(conteudo) values ('  É preciso compreender bem o transporte de tonalidades para sabermos adaptar uma mesma música ao nosso timbre vocal como também para os outros. Para isso, vamos praticar os exercícios abaixo: 
 1ª Tarefa) Coloque os acordes na tonalidade de Cm sabendo dos seus seguintes valores dentro da sequência básica: 
 VALORES: 1o m     5o 7    6o 7     3om     2o    1o 
 
    2ª Tarefa)  Transporte a seguinte seqüência de Eb para a tonalidade de  Em: 
  TOM EMEb   =     Eb   Eb7+   Eb6   Eb7   Fm   Bb7/11   Bb7 
  
    3ª Tarefa)  Na música abaixo, deixamos algumas lacunas a serem preenchidas com acordes cabíveis para seus valores na tonalidade de D. A tarefa consiste em completá-las corretamente. Como dica, sopramos que os valores usados são; 1o, 2o7, 3o7 e 4o acordes. Depois, escolha outras tonalidades para transportar o tom e toque nelas também. 


FIO DE CABELO

Chitãozinho & Xororó	(Fragmento)
...
__	__	__	__
Que aquele fio de cabelo cumprido já esteve grudado em nosso suor


4ª Tarefa)  Durante o trecho da música seguinte, a seqüência é seguidamente C, G, DmAm C e G durante todo o acompanhamento. Descubra apenas o tempo certo da mudança de cada acorde sobre a letra.
MORANGO DO NORDESTE
Lairton	(fragmento)
...
É	somente ela que me satisfaz Ah! É amor.

Há, é amor. É amor.
');
insert into Exercicios(conteudo) values ('Pratique as sequências abaixo e observe os valores de cada acorde e toque a canção: 
1) D   D7+   D7   G   Gm   A7   D 
...
');
insert into Exercicios(conteudo) values ('1ª Tarefa)  Pratique as seqüências abaixo, reconhecendo os valores dos acordes dissonantes:
...
2ª Tarefa)   execute a música abaixo:
...
Que um dia de repente você volte	para min					
G	G6	G		G6 G	Am	D7	Am	D7		
Vejo caminhões e carros apressados		a passar por min					
Am	D7	Am	D7	G		G6	GG6	
Estou sentado à beira de um caminho	que não tem mais fim			
G	G6	G	G6			Am	D7	Am	D7	
E este sol que queima no meu rosto		um resto de esperança			
Am	D7	Am	D7				G	G6	G	G7
De ao menos ver de perto seu olhar		que eu trago na lembrança			
C	D7	GG6	G	G7						
Preciso acabar logo com isso								
C	D7	G				D7G G6 G G6 G		
Preciso lembrar que eu existo. Eu existo,	eu existo.					
');
insert into Exercicios(conteudo) values ('1ª Tarefa)  Exercite as sequências seguintes:

1)  E  E4  E  E4  B7  B7/11 B7  E4

2)	Am7/4  D7  Am7/4 D7 G7+ G6 G7+ G6 G#O  Am7/4 D7 G7+

3)	C D G G6 C Am D G7 C C4 C C4 C7+

4)	FmBbm Eb4/7 Eb7 Ab C7 Fm


2ª Tarefa)  executa a canção observando a aplicação do dissonante 7/11. Entenda também quemesma a letra em inglês, a cifragem é a mesma, pois se trata de uma linguagem universal para a música:
...
G	A7	A7/11A7
Likes orry, like sorry		
D	A7/11	A7	Em
Forgive me, it’s all that you can say
A7/11	A7	D		
Years gone by and still		
A7/11	A7	Bm	
Words don’t come easily	
...
You would be mine
');
insert into Exercicios(conteudo) values ('1a Tarefa: Pratique as seqüências abaixo, observando os valores dos acordes com baixo alterado:

1)	D A/C# BmBm/A G F#m E7 A7/11 A7 D

2)	Em Em/G F#m7 B6/7Em/D Am/C B7 Em

3)	C G/B Am Am/G F Em7 DmDm/C G/B G7 G/B C

4)	F#mF#m/EBmBm/D C#7 F#m C#7 F#m
...
2ª Tarefa) Execute a seguinte canção:
...
De que me vem de forma assim tão cautelosa

D/F# Em Em/D C G/B AmAm/G
...
Eternamente Yolanda...
');
insert into Exercicios(conteudo) values ('1ª Tarefa) Este verdadeiro sucesso internacional tem um arranjo que, aliás, é também a mesmaintrodução. Cifre esse arranjo e execute-o com o acompanhamento:
...
2ª Tarefa)Acompanhe a cifragem da introdução seguinte:
...
3ª Tarefa) Pesquise nas músicas estudadas até agora e em outras, os efeitos de acompanhamentointrodução, arranjos e solo.
');
insert into Exercicios(conteudo) values ('1ª Tarefa)  Pratique as seqüências abaixo observando a aplicação dos acordes dissonantes com anota 9 e 9-:
...
2ª Tarefa)  Execute as estrofes seguintes:
...
No exercício anterior, ciframos as estrofes de uma canção e deixamos o refrão de lado porque precisaríamos de acordes que só agora neste capítulo vimos. Eis então:
...
Bb7+	Em7A5+/7	
Me dá teu calor			
Dm7	C7/9	F7+ Em5-/9A5+/7
Vem me fazer feliz porque eu te amo	
Dm7		C7/9	F7+	
Você deságua em min e eu oceano	
	Gm7	Am7	Bb7+Em5-/7  A5+/7
E esquece que amar é quase uma	do - or
D	F7+ G7+ C	D F7+ G7+ CD7+
Só	sei vi – ver	se for  por  vo - cê.
	Acompanhe também esta música:
