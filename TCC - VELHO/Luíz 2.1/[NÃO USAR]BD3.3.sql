...
instrumentos, como o violão, o saxofone, etc. Desta forma, não há conflitos quando dois ou mais instrumentos tocarem juntos. 
 ...
 -- Módulo 2 Aula 1
insert into Modulo2(titulo,aula) values ('Anatomia do Violão','Veja como se dispõe o corpo do violão:');

-- Imagem m2a1_anatomia_violao e m2a1_cifragem_do_violao
...
-- Imagem m4a3_Cifragem_da_melodia
...
-- Imagem m4a3_Cifragem_da_melodia
-- Imagem m4a3_Cifragem_da_melodia2
...
-- Imagem m4a4_Valor_das_sequencias_de_notas
...
insert into Modulo5(titulo,aula) values ('Escala das notas para formar acordes','Para formar os acordes, unem-se notas combinadas em uma posição. Para saber quais notas para cada acorde nós usamos uma 
escala de notas primas composta de oito notas (ou graus) para cada tonalidade ou tom de acorde. Então, cada tonalidade (maior e menor) recebe uma escala de notas que combinam entre si. Por exemplo, o 
Tom A (maior) vai receber uma escala de oito notas para que a partir de então, sejam formados os acordes relativos à A (A, A7, A4/7, etc.).

ESCALA DAS NOTAS PARA ACORDES:

');

-- Imagem m5a2_Escala_das_notas_para_acorde
...
insert into Modulo5(titulo,aula) values ('Formação dos acordes menores','A formação dos acordes menores é semelhante a dos maiores. As notas básicas são enumeradas 1, 3 e 5 só que, da escala dos acordes menores. Quando formamos D (Ré maior), 
selecionamos as notas de sua escala maior, enquanto que para o acorde Dm (Ré menor) selecionamos suas notas da escala de Dm. Repare:
...
-- imagem m5a3_Formacao_de_acordes_menores
...
insert into Modulo5(titulo,aula) values ('Reconhecendo entre maior e menor','Diferenciar entre acorde maior e menor é ESSENCIAL para a continuação do aprendizado. Para isso, é necessário exercitar o ouvido para distinguir entre um e outro. A técnica para isso é simples; toque um acorde maior por alguns
instantes e em seguida, toque esse mesmo acorde agora como acorde menor. Ex. D e Dm. Depois torne a tocá-lo maior e menor, tantas vezes possível até que tenha assimilado a diferença. Faça isso com os demais acordes e logo, a compreensão será natural.
...
-- Módulo 6 Aula 1 parte 1
insert into Modulo6(titulo,aula) values ('Fórmula para acordes','Existem muitas formas de desenharmos o mesmo acorde no violão, e também, vários acordes num mesmo modelo em casas diferentes. Uma fórmula para acordes é um modelo de cifra usado nas diversas casas e sendo um acorde diferente em cada uma delas.

Observe na figura a seguir com duas cifras com posições diferentes e um mesmo acorde Dm.
');
...
-- Imagem m6a1_formula_acordes

O molde é o mesmo, mas como estão em casas diferentes, as notas se alteram e, logo, o acorde também passa a ser outro. A primeira cifra é um acorde A (Lá maior) e tem as notas A, C# e E. Na segunda cifra, cada nota aumentou uma casa em relação à A; notas A#, D 
e F, sendo o acorde A#. Na cifra seguinte, mais uma casa foi adiantada; notas B, D# e F# que formam o acorde de B. Adiantando a fórmula uma casa, teríamos um novo acorde que seria C, depois C#, D, etc.
...
-- Imagem m6a1_1formula_acordes_maiores
...
insert into Modulo6(titulo,aula) values ('Seqüência básica dos acordes','Já vimos a seqüência básica de D, mas cada acorde tem sua escala própria com seus respectivos acordes e sempre com escalas diferentes.
Através da escala de D, podemos encontrar as demais pela escala completa, veja:
');

-- Imagem m6a2_sequencia_basica_acordes


 -- Módulo 6 Aula 2 parte 2
insert into Modulo6(titulo,aula) values ('Seqüência básica dos acordes','Para encontrar qualquer escala, segue o exemplo acima a começar pelo acorde procurado. Exemplo F# (que o mesmo Gb). A escala completa deve ser iniciada em F#.');

-- Imagem m6a2_sequencia_basica_acordes2

-- Módulo 6 Aula 2 parte 3
insert into Modulo6(titulo,aula) values ('Seqüência básica dos acordes','Para encontrar qualquer escala, segue o exemplo acima a começar pelo acorde procurado. Exemplo F# (que o mesmo Gb). A escala completa deve ser iniciada em F#.');

-- Imagem m6a2_sequencia_basica_acordes3
...
7a m = (sétima nota de Fm) 
Eb F = F, A, C (notas básicas) 
F7 = F, A, C, Eb
Fm = F, Ab, C
Fm7 = F Ab C Eb
...
-- Imagem m7a2_Acordes_com_setima_menor

-- DEIXANDO EM CAIXA ALTA PRA AVALIAR ESSE INSERT {
...
insert into Modulo8(titulo,aula) values ('Sequências Básicas','Quando tocamos uma música, usamos um conjunto de acordes e dizemos que eles formam a seqüência daquela determinada música. Na canção “Caminhando e cantando”
que vimos no MÓDULO 5, usamos os acordes D e Em. Eis, portanto, a seqüência desta música.

Alguns acordes têm uma relação de proximidade com outros dentro de uma seqüência de acordes, e isto
ocorre por causa dos valores de tonalidades que cada um tem. A compreensão desses valores determina a posição de cada acorde dentro da música. Os valores mais comuns --- os mais usados --- são denominados pelos seus valores
numa escala de acordes chamada de seqüência básica, que aprenderemos já.
');
...
TOM	=	1º	2º(7)	3º 7	4º	1ºm	2ºm	3ºm	4ºm	5º (7)	5ºm (7)
...
-- imagem m9a1_Formulas_para_acordes_maiores_com_7+
...
-- Imagem m9a1_Formulas_para_acordes_menores_com_7+
...
-- imagem m10a3_Formulas_para_acordes_maiores_com_6
...
-- imagem m10a3_Formulas_para_acordes_menores_com_6
...
-- imagem m10a5_Formulas_para_acordes_maiores_com_67
...
-- imagem m10a5_Formulas_para_acordes_menores_com_67
...
-- Imagem m11a_Simbologia_dos_ritmos

-- Módulo 11 Aula 3
insert into Modulo11(titulo,aula) values ('Simbologia dos ritmos','Note que o “x” na cifra indica o toque do polegar sobre a nota do baixo (o bordão) e os dedos 1, 2 e 3 tocam as cordas ativas, que às vezes dispensa a 1a corda como na segunda cifra. Quando houver mais de três notas além do baixo, pode-se escolher quaisquer três para a base.');
...
-- Imagem m11a5_O_violao_e_a_bateria
...
-- Imagem m11a3_A_batida_no_pedal
...
-- Imagem m11a5_A_puxada_no_chimbal
...
-- Imagem m11a5_A_batida_na_caixa
...
-- Imagem m11a5_Na_hora_do_repique
...
-- Imagem m11a6_1Balada_jovem_e_rock_pop
-- Imagem m11a6_2Samba
-- Imagem m11a6_3Valsa_parte_cima
-- Imagem m11a6_3Valsa_parte_baixo
-- Imagem m11a6_4Begume
-- Imagem m11a6_5Reggae
-- Imagem m11a6_6Forro_baiao
-- Imagem m11a6_7Forro_universitario_xote
-- Imagem m11a6_8Pagode
-- Imagem m11a6_9Guarania
...
');
-- Imagem m11a7_Ritmos_dedilhados
...
-- Imagem m12a2_Formacao_acordes_7_o
...
-- Imagem m12a5_Acordes_com_setima_diminutiva
...
-- Imagem m13a3_Formulas_pra_acordes_maiores_com_4
...
-- Imagem m13a5_1Formulas_para_acordes_maiores_com_47
...
-- Imagem m13a5_2Formulas_para_acordes_menores_com_47
...
-- Imagem m16a3_1Formulas_para_acordes_maiores_com_9
...
-- Imagem m16a3_2Formulas_para_acordes_menores_com_9
...
-- Imagem m16a4_Acordes_com_49_nem_maiores_nem_menores
...
ESCALA EM D = D E F# G A B C# DEbE
...
-- Módulo 16 Aula 9 parte 2
insert into Modulo16(titulo,aula) values ('Acordes com 7/9-','FÓRMULAS; Para acordes maiores com 7/9-');

-- Imagem m16a9_Formulas_para_acordes_maiores_com_79-


-- Módulo 16 Aula 9 parte 3
-- insert into Modulo16(titulo,aula) values ('Acordes com 7/9-','FÓRMULAS; Para acordes menores com 7/9-:');
