...
select nomecompleto from cadastro where Login = "b";
...
create table VModulo3Aula(
idModulo3 int auto_increment,
M3A1 longtext,
M3A2 longtext,
M3A3 longtext,
M3A4 longtext,
...
M3A15 longtext,
M3E longtext,
primary key(idModulo3)
);
create table VModulo4Aula(
idModulo4 int auto_increment,
M4A1 longtext,
M4A2 longtext,
M4A3 longtext,
M4A4 longtext,
...
M4A15 longtext,
M4E longtext,
primary key(idModulo4)
);
create table VModulo5Aula(
idModulo5 int auto_increment,
M5A1 longtext,
M5A2 longtext,
M5A3 longtext,
M5A4 longtext,
...
M5A15 longtext,
M5E longtext,
primary key(idModulo5)
);
create table VModulo6Aula(
idModulo6 int auto_increment,
M6A1 longtext,
M6A2 longtext,
M6A3 longtext,
M6A4 longtext,
...
M6A15 longtext,
M6E longtext,
primary key(idModulo6)
);
create table VModulo7Aula(
idModulo7 int auto_increment,
M7A1 longtext,
M7A2 longtext,
M7A3 longtext,
M7A4 longtext,
...
M7A15 longtext,
M7E longtext,
primary key(idModulo7)
);
create table VModulo8Aula(
idModulo8 int auto_increment,
M8A1 longtext,
M8A2 longtext,
M8A3 longtext,
M8A4 longtext,
...
M8A15 longtext,
M8E longtext,
primary key(idModulo8)
);
create table VModulo9Aula(
idModulo9 int auto_increment,
M9A1 longtext,
M9A2 longtext,
M9A3 longtext,
M9A4 longtext,
...
M9A15 longtext,
M9E longtext,
primary key(idModulo9)
);


create table ConteudoTeclado(
idConteudoTeclado integer not null auto_increment,
ConteudoInicial longtext,
ConteudoMedio longtext,
ConteudoFinal longtext,
primary key (idConteudoTeclado)
);


insert into Cadastro (Login,Email,Senha,DataNasc,NomeCompleto) values ("luizzluque","Luizz@gmail.com","123456","2016-08-16","Luiz Felipe de Paiva");insert into Cadastro (Login,Email,Senha,DataNasc,NomeCompleto) values ("luizzluque","Luizz@gmail.com","123456","2016-08-16","Luiz Felipe de Paiva");
...
select * from ConteudoViolao;
select * from ConteudoTeclado;

select * from Instrumento;


select m1a1 from vmodulo1aula;
